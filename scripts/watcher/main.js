 ...
 *
 * Requirements:
 * - The first argument should be the path to use as your project's root
 * - All filepaths received must be relative to project root
...
const I18N_LIBRARY_PATH = 'I18N/index.jsx';
